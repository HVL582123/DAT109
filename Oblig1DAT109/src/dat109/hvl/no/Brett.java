...
public class Brett {
	...
	/**
	 * Lager nytt brett med gitt liste av spillere. Plasserer dem så på rute 1 (Start)
	 * Legger til stiger og slanger. Disse er forhåndsdefinert, ikke random. 
	 */
	 ...
	 * bli sjekket etter siste spillers kast om det er flere runder igjen å spille.
	 */
